                ...
                $.each(ctgnumArray,function (i,ctg1Id) {
                    ...
                    $.each(ctg2list,function (i,ctg2) {
                        ...
                        $.each(ctg3List,function (i,ctg3) {
                            var cata3link = $("<a href=\"http://localhost:8090/search.html?catalog3Id="+ctg3.id+"\" style=\"color: #999;\">" + ctg3.name + "</a>");
                            // var cata3link = $("<a href=\"http://localhost:8090/search.html\"></a>")
                            li.append(cata3link);
